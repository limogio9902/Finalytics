...
export default function BudgetTable({ title, items, type = 'expense', onAdd, onUpdate, onDelete }) {
    ...
    return (
        <div className="card" style={{ height: '100%', maxHeight: '500px', display: 'flex', flexDirection: 'column' }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: '0 0.2rem' }}>
                    <thead style={{ position: 'sticky', top: 0, zIndex: 10, background: 'white' }}>
                        <tr style={{ textAlign: 'left', color: 'var(--text-secondary)', fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '1px' }}>
                            <th style={{ padding: '0.5rem', width: '55%', background: 'white', position: 'sticky', top: 0 }}>Name</th>
                            <th style={{ padding: '0.5rem', textAlign: 'right', width: '30%', background: 'white', position: 'sticky', top: 0 }}>Amount</th>
                            <th style={{ padding: '0.5rem', textAlign: 'right', width: '15%', background: 'white', position: 'sticky', top: 0 }}></th>
                        </tr>
                    </thead>
                    <tbody>
                        {items.map((item) => {
